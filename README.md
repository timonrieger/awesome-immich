...
- [Lightroom Immich Plugin: lrc-immich-plugin](https://github.com/tuxpeople/lrc-immich-plugin) - Lightroom plugin to publish and export photos from Lightroom to Immich. Import from Immich to Lightroom is also supported.
...
- [Immich Machine Learning Load Balancer](https://github.com/apetersson/immich_ml_balancer) - Speed up your machine learning by load balancing your requests to multiple computers
